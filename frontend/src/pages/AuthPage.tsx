    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-accent/20 rounded-xl mb-4 animate-pulse">
            <svg
          ...
          <p className="text-slate-400 mt-1 text-sm font-body">
            Your secure task workspace
          </p>
        </div>
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-slate-100 mb-1.5 uppercase tracking-wider">
                Username
              </label>
              <input
                className="input"
